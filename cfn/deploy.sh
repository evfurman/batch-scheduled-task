...
# title: deploy.sh
# description: Deploy Script for Task Runner using Batch and Cloudwatch Events
# author: evfurman@gmail.com

# Define Params

STACK_NAME=batch-scheduled-task
...
# Create new stack
	...
	aws cloudformation create-stack \
        ...
        --template-body file://./batch-scheduled-task.template \
